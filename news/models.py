...
class NewspaperIssue(models.Model):
    ...
    publication_date = models.DateField("Public date",
                                        auto_now_add=True)
    editors = models.ManyToManyField(User,
                                     verbose_name="Editors")
    topics = models.ManyToManyField(Topic, verbose_name="Topics",
                                    blank=True)
    photo = models.ImageField("Image", upload_to='news_photos/',
...
class Comment(models.Model):
    issue = models.ForeignKey('NewspaperIssue',
...
class Reaction(models.Model):
    ...
    reaction = models.CharField("Reaction",
                                max_length=7,
